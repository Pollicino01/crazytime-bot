        ...
        if fase_ciclo == 0:
            ...
            if tipo_numero == "5":
                ...
                if sessioni_giocate >= MAX_SESSIONI:
                    ...
                    reset_totale()
                else: invia(f"❌ Ciclo perso. Restano {MAX_SESSIONI - sessioni_giocate} tentativi.")
...
def run_telebot():
    # --- QUESTA PARTE RISOLVE L'ERRORE 409 ---
    bot.remove_webhook()
    time.sleep(2)
...
if __name__ == "__main__":
    ...
    invia("✅ **Bot Online!** Conflitto risolto e monitoraggio attivo.")
    ...
    while True:
        ...
        time.sleep(POLL_INTERVAL)import os
import time
import re
import requests
import telebot
